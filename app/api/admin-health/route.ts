...
// Reads base64-encoded PEM from FIREBASE_ADMIN_PRIVATE_KEY_B64.
function getCred() {
...
export async function GET() {
    try {
        ...
        // Lightweight auth call to verify Admin SDK works:
        await app.auth().listUsers(1);
        return NextResponse.json({ ok: true, msg: "admin OK" }, { status: 200 });
    } catch (err: any) {
